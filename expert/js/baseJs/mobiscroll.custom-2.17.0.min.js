...
(function (a, n) {
    ...
    w.classes.Slider = function (f, s, r) {
        function b(b) {
            d(b, this) && !H && !f.disabled && a.mobiscroll.running && (H = !0, x = Y = !1, fa = j(b, "X"), v = j(b, "Y"), M = fa, c.removeClass("mbsc-progress-anim"), I = E ? a(".mbsc-slider-handle", this) : L, m = I.parent().addClass("mbsc-active"), p = +I.attr("data-index"), ka = c.outerWidth(), N = c.offset().left, "mousedown" === b.type && (b.preventDefault(), a(document).on("mousemove", g).on("mouseup", P)))
        }
        ...
        v.position =
            function (e) {
                ...
                if (!(ha === B && fa === s && e || Y))if ((v._isFullScreen || /top|bottom/.test(E.display)) && J.width(B), !1 !== V("onPosition", [c, B, s]) && F) {
                    ...
                    "modal" == E.display ? (f = Math.max(0, f + (B - Q) / 2), g = e + (s - T) / 2) : "bubble" == E.display ? (q = !0, h = a(".dw-arrw-i", c), g = i.offset(), oa = Math.abs(G.offset().top - g.top), k = Math.abs(G.offset().left - g.left), o = i.outerWidth(), i = i.outerHeight(), f = b(k - (J.outerWidth(!0) - o) / 2, f + 3, f + B - Q - 3), g = oa - T, g < e || oa >
                    e + s ? (J.removeClass("dw-bubble-top").addClass("dw-bubble-bottom"), g = oa + i) : J.removeClass("dw-bubble-bottom").addClass("dw-bubble-top"), h = h.outerWidth(), o = b(k + o / 2 - (f + (Q - h) / 2), 0, h), a(".dw-arr", c).css({left: o})) : "top" == E.display ? g = e : "bottom" == E.display && (g = e + s - T);
                    g = 0 > g ? 0 : g;
                    H.top = g;
                    H.left = f;
                    J.css(H);
        ...
        v.show = function (b, e) {
            ...
            if (!E.disabled && !v._isVisible) {
                ...
                if (F) {
                    ...
                    r && p && !b && c.addClass("dw-in dw-trans").on("webkitAnimationEnd animationend", function () {
                        c.off("webkitAnimationEnd animationend").removeClass("dw-in dw-trans").find(".dw").removeClass("dw-" + p);
                        e || J.focus();
                        v.ariaMessage(E.ariaMessage)
                    }).find(".dw").addClass("dw-" + p)
    ...
    f.ListView = function (e, d) {
        ...
        function G(c) {
            ...
            if (za.actions)10 < Math.abs(oa) && ia && (R(ba, 0 > oa ? -ia : ia, 200), h = d = !0, Ka = ba, gb = ra, a(t).on("touchstart.mbsc-lv-conf mousedown.mbsc-lv-conf", function (a) {
                ...
                M(ba, !0, c)
                    ...
                    e = 300 > e && 50 < la, b ? (Lb = !0, Ja = za.left, Z(Ja, ca.iconSlide)) : e && (Lb = !0, Ja = za.right, Z(Ja, ca.iconSlide))), Ja && Ja.action)Sa = aa(Ja.disabled, [ba, ra, $]), Sa || (d = !0, (h = xb || aa(Ja.confirm, [ba, ra, $])) ? (R(ba, 100 * (0 > oa ? -1 : 1) * Da.outerWidth(!0) / ab, 200, !0), l(Ja, ba, ra, !1, c)) : J(Ja, ba, ra, c));
            d || M(ba, !0, c);
            kb = !1
        }
        ...
        $.add = function (c, b, e, d, f, g) {
            ...
            C(p, function (c) {
                ...
                if (q.hasClass("mbsc-lv-v"))$.animate(p.height(p.outerHeight()), g && Tb === F ? "none" : "expand", function (a) {
...
(function (a, n, t, w) {
    ...
    h.Scroller = function (P, i, n) {
        ...
        function m(c) {
            ...
            a.each(f, function (c, f) {
                ...
                b += '<div role="option" aria-selected="false" class="dw-li dw-v" data-val="' + g[c] + '"' + (d[c] ? ' aria-label="' +
                    d[c] + '"' : "") + ' style="height:' + p/36 + "rem;line-height:" + p/36 + 'rem;"><div class="dw-i"' + (1 < ka ? ' style="line-height:' + Math.round(p / ka) + "px;font-size:" + Math.round(0.8 * (p / ka)) + 'px;"' : "") + ">" + f + C._processItem(a, 0.2) + "</div></div>";
                e++
            });
            return b += "</div>"
        }
        ...
        function G(a, c, b, e, g) {
            ...
            i == Z[c] && pa[c] || (Z[c] = i, f ? (l[d + "Transition"] = j.prefix + "transform " + (e ? e.toFixed(3) : 0) + "s ease-out", l[d + "Transform"] = "translate3d(0," + i/36 + "rem,0)") : l.top = i/36 + "rem", pa[c] && U(a, c), e && g && (a.closest(".dwwl").addClass("dwa"), pa[c] = setTimeout(function () {
                U(a, c)
            }, 1E3 * e)), ia[c] = b)
        }
        ...
        C._generateContent = function () {
            ...
            a.each(F.wheels, function (d, f) {
                b += '<div class="mbsc-w-p dwc' + ("scroller" != F.mode ? " dwpm" : " dwsc") + (F.showLabel ? "" : " dwhl") + '"><div class="dwwc"' + (F.maxWidth ? "" : ' style="max-width:8rem;"') + ">" + (s ? "" : '<table class="dw-tbl" cellpadding="0" cellspacing="0"><tr>');
                a.each(f, function (a, d) {
                    Ba[e] = d;
                    c = d.label !==
                    w ? d.label : a;
                    b += "<" + (s ? "div" : "td") + ' class="dwfl" style="' + (F.fixedWidth ? "width:" + (F.fixedWidth[e] || F.fixedWidth) + "px;" : (F.minWidth ? "min-width: 1.667rem;" : "min-width:" + F.width + "px;") + (F.maxWidth ? "max-width:" + (F.maxWidth[e] || F.maxWidth) + "px;" : "")) + '"><div class="dwwl dwwl' + e + (d.multiple ? " dwwms" : "") + '">' + ("scroller" != F.mode ? '<div class="dwb-e dwwb dwwbp ' + (F.btnPlusClass || "") + '" style="height:' + p + "px;line-height:" + p + 'px;"><span>+</span></div><div class="dwb-e dwwb dwwbm ' + (F.btnMinusClass ||
                        "") + '" style="height:' + p + "px;line-height:" + p + 'px;"><span>&ndash;</span></div>' : "") + '<div class="dwl">' + c + '</div><div tabindex="0" aria-live="off" aria-label="' + c + '" role="listbox" class="dwww"><div class="dww" style="height:' + F.rows * 1.111 + 'rem;"><div class="dw-ul" style="margin-top: 2.222rem;">';
                    b += m(e) + '</div></div><div class="dwwo"></div></div><div class="dwwol"' + (F.selectedLineHeight ? ' style="height: 1.111rem;margin-top:-0.583rem;"' : "") + "></div></div>" + (s ? "</div>" : "</td>");
                    e++
                });
...
(function (a, n, t, w) {
    ...
    d.MenuStrip = function (f, s) {
        ...
        function b(b, c) {
            if (b.length) {
                var d = b.offset().left, e = b[0].offsetLeft, f = b.outerWidth(), h = o.offset().left;
                A = b;
                c === w && (c = !I);
...
(function (a, n, t, w) {
    ...
    s.calendar = function (b) {
        ...
        function i(b) {
            ...
            var d = b.outerHeight(), f = b.outerWidth(), g = b.offset().top - a(".dw-cal-c", k).offset().top, h = 2 > b.closest(".dw-cal-row").index();
