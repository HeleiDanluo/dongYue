    ...
    h.Scroller = function (P, i, n) {
        ...
        function m(c) {
            ...
            a.each(f, function (c, f) {
                ...
                b += '<div role="option" aria-selected="false" class="dw-li dw-v" data-val="' + g[c] + '"' + (d[c] ? ' aria-label="' +
                    d[c] + '"' : "") + ' style="height:1.111rem;line-height:1.111rem;"><div class="dw-i"' + (1 < ka ? ' style="line-height:' + Math.round(p / ka) + "px;font-size:" + Math.round(0.8 * (p / ka)) + 'px;"' : "") + ">" + f + C._processItem(a, 0.2) + "</div></div>";
                e++
            });
            return b += "</div>"
        }
        ...
        C._generateContent = function () {
            ...
            a.each(F.wheels, function (d, f) {
                b += '<div class="mbsc-w-p dwc' + ("scroller" != F.mode ? " dwpm" : " dwsc") + (F.showLabel ? "" : " dwhl") + '"><div class="dwwc"' + (F.maxWidth ? "" : ' style="width:18rem;"') + ">" + (s ? "" : '<table class="dw-tbl" cellpadding="0" cellspacing="0"><tr>');
