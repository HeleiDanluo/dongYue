...
$(function () {
    ...
    $(".bodyQuality").tabBox({
        callback: function () {
            ...
            var data1 = [71, 62, 82, 32, 55, 48, 71,56];
            var data2 = null
            var option3
            function test(){
                return option3 = {
            ...
            if(data1) {
                shentisuzhi.setOption(test());
            }else{
                $('.shentisuzhi').append($('<div class="abso">数据不存在</div>'))
            }
            if(data2) {
                yundongsuzhi.setOption(option2);
            }else{
                $('.yundongsuzhi').append($('<div class="abso">数据不存在</div>'))
            }
        }
    });
